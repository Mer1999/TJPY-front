...
public class picsim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(picsim.this,sim.class);
                if (isAndroidQ) {
                    // Android 10 使用图片uri加载
                    intent.putExtra("imageUri", mCameraUri.toString());
                } else {
                    // 使用图片路径加载
                    intent.putExtra("imageUri",mCameraImagePath);
                }
